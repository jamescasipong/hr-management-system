...
import { Mail, Phone, MessageSquare, MapPin, Clock, CheckCircle2, ArrowRight, Github, Twitter, Linkedin, Facebook } from 'lucide-react'
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">support@hrconnect.com</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">Available for Premium plans</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <CardContent>
                {isSubmitted ? (
                  <div className="text-center py-8">
                    ...
                    <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">Thank you for contacting us!</h3>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <TabsContent value="sales">
                                ...
                                <SelectItem value="upgrade">Upgrade Account</SelectItem>
                              </TabsContent>
                            </SelectContent>
                          </Select>
                        </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Our standard support hours are Monday to Friday, 9AM to 6PM EST. Premium and Enterprise plans have access to extended support hours.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      We aim to respond to all inquiries within 24 hours. Technical support tickets are prioritized based on severity and plan level.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      Phone support is available for Premium and Enterprise plans. Standard plans have access to email and ticket-based support.
                    </p>
                  </div>
