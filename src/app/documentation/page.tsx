        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div id="getting-started" className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  Welcome to HRConnect! This guide will help you get started
              ...
              <div className="mt-8">
                <Tabs defaultValue="overview">
                  ...
                  <TabsContent
                    value="overview"
                    className="p-4 border rounded-md mt-2 dark:border-gray-700"
                  >
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">
                      HRConnect Overview
                    </h3>
                    <p className="mt-2 text-gray-600 dark:text-gray-300">
                      HRConnect is a comprehensive HR management platform
                      designed to streamline your HR processes, boost employee
                      productivity, and provide valuable insights through
                      data-driven analytics.
                    </p>
                    <p className="mt-2 text-gray-600 dark:text-gray-300">
                      Our platform offers a range of modules including employee
                      management, attendance tracking, leave management, payroll
                  ...
                  >
                    ...
                    <ul className="mt-2 space-y-2 text-gray-600 dark:text-gray-300">
                      <li className="flex items-start">
                        ...
                        <span>
                          Centralized employee database with comprehensive
                          profiles
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>
                          Automated attendance tracking with multiple check-in
                          options
                        </span>
                      </li>
                      <li className="flex items-start">
                        ...
                        <span>
                          Streamlined leave management with approval workflows
                        </span>
                      </li>
                      <li className="flex items-start">
                      ...
                      <li className="flex items-start">
                        ...
                        <span>
                          Customizable settings to match your company policies
                        </span>
                      </li>
                    </ul>
                  </TabsContent>
                    ...
                    <div className="mt-2 space-y-4">
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          HRConnect works on all modern browsers including
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          Our mobile app is available for iOS (12.0+) and
                          Android (8.0+) devices. Employees can also access the
                          platform via mobile web browsers.
                        </p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-800 dark:text-gray-200">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          A stable internet connection is required for real-time
            ...
            <div className="mt-12 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-300">
                Integrate HRConnect with your existing systems using our
                comprehensive API.
              </p>
                ...
                <Card className="dark:border-gray-700">
                  ...
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Our REST API provides access to all HRConnect resources
                      and supports standard HTTP methods.
                    </p>
                ...
                <Card className="dark:border-gray-700">
                  ...
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      ...
                      when data changes in HRConnect.
                    </p>
                    <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-md font-mono text-sm overflow-x-auto">
              ...
              <div className="mt-6">
                <Card className="dark:border-gray-700">
                  ...
                  <CardContent>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      All API requests must be authenticated using API keys or
                      OAuth 2.0.
                    </p>
                    ...
                    <div className="mt-4 space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          For user-specific actions, use OAuth 2.0 to request
